...
| --- | --- | --- | --- | --- | --- |
| CREDFILE | PF | CHAIN | CustID | Fetch customer credit profile (limit, risk rating, status) | [EV-CREDIT-VALIDATION-002] |
...
| --- | --- | --- | --- | --- |
| Record not found (CustID not in CREDFILE) | CHAIN with %found() check | Return decision 'D' (DENIED) and set ApprovedAmount = 0 | Customer request denied; proceed to next transaction | [EV-CREDIT-VALIDATION-001, lines 30–32] |

...
```
TBD-CREDIT-CHECK-001: Missing DDS → blocking: pending_source
TBD-CREDIT-CHECK-002: Unhandled errors → blocking: pending_sme_judgment
TBD-CREDIT-CHECK-003: Unused file → blocking: pending_sme_judgment
TBD-CREDIT-CHECK-004: Return code convention → blocking: non_blocking
```
...
### missing Examples
- CREDFILE DDS is referenced but not provided → TBD-CREDIT-CHECK-001
...
✅ RIGHT:
"TBD-CREDIT-CHECK-001: CREDFILE DDS not provided. 
...
TBD-CREDIT-CHECK-002: Confirm whether this is intentional."
```
...
Link: EV-CREDIT-CHECK-001 (RPGLE P spec, lines 19–24)"
```
...
TBD-CREDIT-CHECK-003: Confirm whether this file should be removed."
```

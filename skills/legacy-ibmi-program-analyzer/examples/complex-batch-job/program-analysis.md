# Program Analysis: Order Submission Batch Job (OBJ-ORDER-SUBMIT-001)

## Metadata

- **Program ID:** OBJ-ORDER-SUBMIT-001
...
**Evidence links:**
- [EV-ORDER-SUBMIT-001: RPGLE H spec and procedure headers]
...
| --- | --- | --- | --- | --- | --- |
| ORDFILE | PF | READ (loop) | (implicit sequential) | Read pending orders one by one | [EV-ORDER-SUBMIT-002] |
| CUSTFILE | LF | (Declared, not accessed) | — | Not used in this program | [EV-ORDER-SUBMIT-003] |
| SHIPFILE | PF | CHAIN | OrderAmount | Lookup shipping cost table by order amount | [EV-ORDER-SUBMIT-004] |
| CUSTMSTR | UF | CHAIN | CustID | Fetch and lock customer master record for update | [EV-ORDER-SUBMIT-005] |
...
**Evidence links:**
- [EV-ORDER-SUBMIT-002: F-spec lines 15–18; READ statement line 46]
- [EV-ORDER-SUBMIT-003: F-spec line 17; no I/O statements]
- [EV-ORDER-SUBMIT-004: F-spec line 16; CHAIN in GetShipCost line 107]
- [EV-ORDER-SUBMIT-005: F-spec line 19; CHAIN in ValidateCredit line 88]

**Unresolved:**
- TBD-ORDER-SUBMIT-001: Confirm ORDFILE record structure (field names for ORDID, CUSTID_FK, AMOUNT)
- TBD-ORDER-SUBMIT-002: Confirm SHIPFILE key field (is OrderAmount the key, or is it a range lookup?)
...
| --- | --- | --- | --- | --- |
| UPDTRISK | RPGLE Program | (CustID: numeric, OrderAmount: decimal, RC: numeric output) | Update customer risk profile after order approval | [EV-ORDER-SUBMIT-006] |
...
**Evidence links:**
- [EV-ORDER-SUBMIT-006: CALL statement line 66]

**Unresolved:**
- TBD-ORDER-SUBMIT-003: Confirm UPDTRISK return codes (what error codes possible?)
...
| --- | --- | --- | --- | --- |
| File operation error (OPEN/READ/CHAIN) | MONITOR block (lines 38–79) | Catch any unhandled exception; set ReturnCode = -99; send message to QSYSOPR | Send message and exit batch job | [EV-ORDER-SUBMIT-007] |
| Invalid credit (validation fails) | IF CreditStatus = 'D' | Increment ErrorCount; set RC = -1; skip order processing | Continue to next order | [EV-ORDER-SUBMIT-008] |
| UPDTRISK returns error | IF RC ≠ 0 | Increment ErrorCount; continue loop | Continue to next order | [EV-ORDER-SUBMIT-009] |
...
**Evidence links:**
- [EV-ORDER-SUBMIT-007: MONITOR / ON-ERROR block lines 38–79]
- [EV-ORDER-SUBMIT-008: IF statement line 59 checking CreditStatus]
- [EV-ORDER-SUBMIT-009: IF statement line 68 checking RC from UPDTRISK]
...
### Pending Source
- **TBD-ORDER-SUBMIT-001:** Confirm ORDFILE record structure
  ...
  - Related: [OBJ-ORDER-SUBMIT-001]

- **TBD-ORDER-SUBMIT-002:** Confirm SHIPFILE key field and lookup logic
  - Blocking: pending_source
...
- [ ] Error handling aligns with production reliability requirements — **See TBD-ORDER-SUBMIT-004**
...
- [X] All evidence links reference existing inventory items — EV-* IDs align with ORDER-SUBMIT scope

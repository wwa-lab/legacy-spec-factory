...
| `module-overview.md` + Program/Data views approved, no approved BRD Package | `continued` (one CAP-* per BRD) | `legacy-brd-writer` |
| `module-overview.md` + Program/Data views approved + approved BRD Package | `continued` (one CAP-* per spec) | `legacy-spec-writer` |

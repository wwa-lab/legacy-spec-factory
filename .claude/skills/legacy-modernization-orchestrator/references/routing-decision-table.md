...
| 3f — Module Analysis Done, no approved BRD Package | Produce legacy BRD for SME / business discovery review | `legacy-brd-writer` | **Implemented v0.1.6** | One legacy-system-only BRD Package per selected `CAP-*`; sections 1-9 are required for review, 10-12 optional/evidence-backed |

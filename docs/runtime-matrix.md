...
| `legacy-ibmi-module-analyzer` | v0.1.3 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-module-analyzer-v0.1.3-scorecard.md) | 2026-05-29 | v0.1.3 owns canonical four-flow module artifacts under `04_modules/`; three-runtime smoke pending. |

...
| `legacy-ibmi-program-analyzer` | v0.2.4 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-program-analyzer-v0.2.4-scorecard.md) | 2026-06-02 | v0.2.4 requires Routine Logic Details to include field calculation rows, routine-local lineage/carrier rows, and routine-local exception closure rows; three-runtime execution evidence pending. |
...
| `legacy-step-validator` | v0.1.7 | synced | synced | synced | [scorecard](reviews/legacy-step-validator-v0.1.7-scorecard.md) | 2026-06-02 | v0.1.7 validates downstream consumption of analyzer v0.2.4 routine-local carrier/exception evidence in flow lineage and exception propagation; updated runtime smoke pending. |

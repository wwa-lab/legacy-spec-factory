...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.6 | synced | synced | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.6-scorecard.md) | 2026-05-30 | v0.2.6 routes module analysis to legacy BRD discovery, keeps No-gap / Gap1 / Gap2 in a post-BRD disposition gate, and blocks spec/handoff until explicit promotion; expanded-route execution still needed. |
...
| `legacy-spec-writer` | v0.1.3 | synced | synced | synced | [scorecard](reviews/legacy-spec-writer-v0.1.3-scorecard.md) | 2026-05-30 | v0.1.3 requires approved BRD plus explicit post-BRD promotion / disposition before spec-writing; three-runtime smoke pending. |

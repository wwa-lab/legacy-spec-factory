...
| `legacy-module-context-intake` | v0.1.0 | synced | synced | synced | [scorecard](reviews/legacy-module-context-intake-v0.1.0-scorecard.md) | 2026-05-21 | Runtime copies synced; positive/negative no-write execution smoke still pending. |
...
| `legacy-brd-writer` | v0.1.2 | synced | synced | synced | [scorecard](reviews/legacy-brd-writer-v0.1.2-scorecard.md) | 2026-05-22 | v0.1.2 adds `validation-scenarios.md` and `VAL-*` scenario seeds; adapter copies are synced, three-runtime smoke pending. |
...
| `legacy-sme-review-facilitator` | v0.1.1 | synced | synced | synced | [scorecard](reviews/legacy-sme-review-facilitator-v0.1.1-scorecard.md) | 2026-05-22 | Conversation Review Mode update is synced; three-runtime chat-review smoke pending. |

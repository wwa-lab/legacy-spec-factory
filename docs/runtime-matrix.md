...
| `legacy-flow-context-normalizer` | v0.1.12 | synced | synced | synced | [scorecard](reviews/legacy-flow-context-normalizer-v0.1.12-scorecard.md) | 2026-06-03 | v0.1.12 recasts normalization as evidence-bounded elicitation and coverage; execution smoke pending. |

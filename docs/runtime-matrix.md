...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.10 | synced | synced | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.10-scorecard.md) | 2026-06-02 | v0.2.10 aligns routing and gates with program v0.2.5, flow v0.2.2, module v0.2.2, and spec v0.1.6 routine-local evidence consumption; expanded-route execution still needed. |
...
| `legacy-ibmi-module-analyzer` | v0.2.2 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-module-analyzer-v0.2.2-scorecard.md) | 2026-06-02 | v0.2.2 carries routine-local lineage/exception evidence into View 4, module readiness, and exception-aware data risks; three-runtime execution evidence pending. |

...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.11 | synced | synced | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.11-scorecard.md) | 2026-06-03 | v0.2.11 routes document/RAG context through evidence-bounded coverage and BRD source eligibility gates; expanded-route execution still needed. |
| `legacy-module-context-intake` | v0.1.7 | synced | synced | synced | [scorecard](reviews/legacy-module-context-intake-v0.1.7-scorecard.md) | 2026-06-03 | v0.1.7 adds source eligibility labels and accepts incomplete SME fragments while keeping generated/candidate context out of BRD conclusions; execution smoke pending. |
...
| `legacy-ibmi-program-analyzer` | v0.2.5 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-program-analyzer-v0.2.5-scorecard.md) | 2026-06-02 | v0.2.5 requires Routine Logic Details to include conditioned calculation block rows, outcome reverse trace rows, front-loaded Validation Logic, field calculation rows, routine-local lineage/carrier rows, and routine-local exception closure rows; three-runtime execution evidence pending. |
...
| `legacy-ibmi-module-analyzer` | v0.2.3 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-module-analyzer-v0.2.3-scorecard.md) | 2026-06-03 | v0.2.3 adds BRD source eligibility to module coverage so generated/candidate rows become questions/TBDs; three-runtime execution evidence pending. |
| `legacy-brd-writer` | v0.1.8 | synced | synced | synced | [scorecard](reviews/legacy-brd-writer-v0.1.8-scorecard.md) | 2026-06-03 | v0.1.8 adds the BRD source-of-truth firewall; three-runtime smoke pending. |
...
| `legacy-step-contract` | v0.1.2 | passed | passed | passed | [scorecard](reviews/legacy-step-contract-v0.1.2-scorecard.md) | 2026-05-29 | Terminology-only update aligned scattered context with the four-view context boundary. Prior positive and negative smoke passed across all three runtimes. |
| `legacy-step-validator` | v0.1.8 | synced | synced | synced | [scorecard](reviews/legacy-step-validator-v0.1.8-scorecard.md) | 2026-06-02 | v0.1.8 validates program-analysis conditioned calculation block, outcome reverse-trace, and front-loaded Validation Logic coverage plus downstream routine-local evidence consumption; updated runtime smoke pending. |

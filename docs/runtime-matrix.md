...
| `legacy-current-state-discovery` | v0.1.0 | synced | synced | synced | [scorecard](reviews/legacy-current-state-discovery-v0.1.0-scorecard.md) | 2026-07-01 | New document-first current-state functional discovery skill; adapter sync and local validator smoke passed; filled golden sample and three-runtime execution smoke pending. |
...
| `legacy-ibmi-program-list-batch` | v0.1.0 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-program-list-batch-v0.1.0-scorecard.md) | 2026-06-25 | New supplemental Copilot Chat-only batch-control skill. Adapter sync and local queue/status script smoke passed; prompt-driven company Copilot Chat smoke pending. |
...
| `legacy-ibmi-flow-analyzer` | v0.4.0 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-flow-analyzer-v0.4.0-scorecard.md) | 2026-07-21 | Controlled Reader-First Program Analysis Merger for coverage-complete SME/Dify Core Reviews. Static score 9.51; accepted score capped at 9.0 because the native Windows PowerShell path and three-runtime prompt smoke were not run. |

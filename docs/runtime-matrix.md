...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.3 | synced | synced | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.3-scorecard.md) | 2026-05-28 | v0.2.3 routes Function Spec, Technical Design, Program Spec, File Spec, interface spec, and data dictionary inputs to flow-context normalization when four-flow context is not reviewed; expanded-route execution still needed. |
| `legacy-flow-context-normalizer` | v0.1.6 | synced | synced | synced | [scorecard](reviews/legacy-flow-context-normalizer-v0.1.6-scorecard.md) | 2026-05-28 | v0.1.6 accepts Function Specs, Technical Designs, Program Specs, File Specs, interface specs, data dictionaries, and mixed spec workbooks while keeping Mermaid diagrams, multi-sheet Excel extraction, sparse triage, and risk acceptance; execution smoke pending. |
| `legacy-module-context-intake` | v0.1.2 | synced | synced | synced | [scorecard](reviews/legacy-module-context-intake-v0.1.2-scorecard.md) | 2026-05-27 | v0.1.2 accepts owner-risk-approved sparse flow-normalization packages as low-confidence `ready_with_warnings` input; positive/accepted-sparse/negative no-write execution smoke pending. |
...
| `legacy-brd-writer` | v0.1.3+SME-1-9 | synced | synced | synced | [scorecard](reviews/legacy-brd-writer-v0.1.3-scorecard.md) | 2026-05-26 | SME 1-9 functional-analysis alignment added after v0.1.3; adapter copies need resync and three-runtime smoke pending. |

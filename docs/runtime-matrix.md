...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.9 | synced | synced | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.9-scorecard.md) | 2026-06-02 | v0.2.9 aligns routing and code-backed gates with analyzer v0.2.1 coverage for Call Evidence, source identifier + meaning fields, File I/O Purpose, dynamic-call resolution, Error Code Inventory, edge resolution, persistence purpose, and exception chains; expanded-route execution still needed. |
...
| `legacy-ibmi-program-analyzer` | v0.2.1 | synced | synced | synced | [scorecard](reviews/legacy-ibmi-program-analyzer-v0.2.1-scorecard.md) | 2026-06-02 | v0.2.1 tightens program-analysis report output with Call Evidence, source identifier + business meaning fields, File I/O Purpose, dynamic-call resolution status, Error Code Inventory, Routine / Window Data Flow, and centralized Open Items; three-runtime execution evidence pending. |
...
| `legacy-spec-writer` | v0.1.5 | synced | synced | synced | [scorecard](reviews/legacy-spec-writer-v0.1.5-scorecard.md) | 2026-06-02 | v0.1.5 consumes analyzer v0.2.1 edge resolution, source identifier + meaning fields, File I/O Purpose, Error Code Inventory, persistence, and exception-chain evidence for observed behaviors, outputs, data model fields, and exceptions; three-runtime smoke pending. |
...
| `legacy-step-validator` | v0.1.3 | synced | synced | synced | [scorecard](reviews/legacy-step-validator-v0.1.3-scorecard.md) | 2026-06-02 | v0.1.3 validates analyzer v0.2.1 contracts for Call Evidence, source identifier + meaning fields, File I/O Purpose, dynamic-call resolution, Error Code Inventory, edge resolution, lineage, persistence, exception chains, and module readiness; updated runtime smoke pending. |

...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `legacy-modernization-orchestrator` | v0.2.2 | synced | passed | synced | [scorecard](reviews/legacy-modernization-orchestrator-v0.2.2-scorecard.md) | 2026-05-27 | v0.2.2 routes owner-accepted sparse flow-normalization packages to context intake while blocking direct module/BRD use. Prior Claude Code evidence-ready and inventory-blocked scenarios passed; Codex/OpenCode and expanded-route execution still needed. |
| `legacy-flow-context-normalizer` | v0.1.5 | synced | synced | synced | [scorecard](reviews/legacy-flow-context-normalizer-v0.1.5-scorecard.md) | 2026-05-27 | v0.1.5 adds owner risk acceptance for sparse inputs while keeping Mermaid diagrams, multi-sheet Excel extraction, and non-blocking placeholders; adapter copies are synced, positive/partial/sparse/risk-accepted/negative no-write execution smoke pending. |

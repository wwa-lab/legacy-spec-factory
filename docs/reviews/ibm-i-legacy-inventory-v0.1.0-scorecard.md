# Skill Review Scorecard: ibm-i-legacy-inventory v0.1.0
...
```text
Revise ibm-i-legacy-inventory to move from 9.0 to 9.5.
...
Keep the canonical skill under skills/ibm-i-legacy-inventory/.

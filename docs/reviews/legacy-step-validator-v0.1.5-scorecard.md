...
superseded_by: docs/reviews/legacy-step-validator-v0.1.6-scorecard.md
...
# Skill Review Scorecard: legacy-step-validator v0.1.5

## Change Under Review

v0.1.5 aligns validator checks with program-analyzer v0.2.3. Program-analysis
validation now checks that every load-bearing routine/subroutine/procedure has
Routine Logic Details with step-by-step logic, field calculation / assignment
rows, branch outcomes, exits, evidence, and unresolved operand/precision/branch
gaps as TBDs.
...
A 9.0 cap applies because v0.1.5 checklist changes have not yet been
...
Final score before cap: **9.57 / 10**
...
| --- | --- | --- | --- |
| STEP-VAL-050 | Medium | v0.1.5 Routine Logic Details validation has not been smoke-executed across the three target runtimes. | Run positive and blocked validations against analyzer v0.2.3 artifacts, including a blocked fixture where subroutine field calculations are summarized but not detailed. |

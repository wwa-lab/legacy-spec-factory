...
| 9 | `legacy-brd-writer` | Legacy BRD factory | Existing | Repo-ready after v0.1.2 validation-scenario update; run three-runtime smoke and rescore before field-pilot label |

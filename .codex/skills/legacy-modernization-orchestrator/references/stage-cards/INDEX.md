...
| --- | --- | --- |
| `legacy-flow-context-normalizer` | Scattered Visio / Word / Excel / PDF / PowerPoint / SME-note docs exist, but standard flows are not yet normalized or SME-reviewed; sparse authorized inputs still need source-quality triage instead of invented flows | See SKILL.md |

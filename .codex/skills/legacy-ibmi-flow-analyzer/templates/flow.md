...
| --- | --- | --- | --- | --- |
| NODE-[SLUG]-01 | [PROGRAM] (OBJ-[SLUG]-[NNN]) | entry / orchestrator / worker / data-access / reporter / exit | `program-analysis-OBJ-[SLUG]-[NNN].md` | [notes] |
...
| --- | --- | --- | --- | --- | --- |
| EDGE-[SLUG]-01 | (trigger) → NODE-[SLUG]-01 | [type] | [pointer] | always | EV-... |
...
| --- | --- | --- | --- | --- | --- |
| DATA-[SLUG]-01 | EDGE-[SLUG]-01 | CALL parameters / DTAARA / DTAQ / shared file / spool / IFS / MSGQ / actgrp-globals / out-of-band | [field name + type] | [producer] → [consumer] | EV-... |
...
| --- | --- | --- | --- | --- |
| BR-[SLUG]-01 | NODE-[SLUG]-NN line XXX | [field / condition] | [outcome A → NODE-X; outcome B → NODE-Y] | EV-... |
